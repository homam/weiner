...
(function() {
  $(function() {
    ...
    skills = [['.NET', 'AJAX', 'd3', 'MVC', 'C#', 'CSS3', 'Casual Games', 'Distributed Syststems', 'Architecture', 'Scrum', 'SOA', 'SQL', 'Git', 'JavaScript', 'HTML5'], ['Cloud Computing', 'Simulations', 'Haskell', 'Canvas', 'SVG', 'Objective-C', 'Node.js', 'Data Visualization', 'XML'], ['ActionScript', 'Mathematica', 'Python', 'Ruby', 'R', 'Java', 'Scala']];
